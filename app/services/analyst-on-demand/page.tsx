...
export default function AnalystOnDemandPage() {
  return (
    <div>
      <Hero
        badge="Service"
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-neutral-700 mb-8 leading-relaxed">
              Our Analyst on Demand service leverages the Forward-Deployed Engineering (FDE) strategy. Forward-Deployed Engineers are software/product engineers who embed directly with customers. They act as the bridge between your environment and the Covenda AI. Unlike traditional SaaS vendors who build generic products and force everyone into them, FDEs willingly "do things that don't scale" early to discover product–market fit, then abstract and scale the patterns that work.
            </p>
            <p className="text-lg text-neutral-700 mb-8 leading-relaxed">
      ...
      <FeatureGrid
        ...
        features={[
          ...
          },
          {
            ...
            description:
              'Each FDE builds on previous work. Shared playbooks, automations, and patterns accelerate every engagement.',
          },
        ]}
      />
    </div>
