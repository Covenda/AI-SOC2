  ...
  return (
    <div>
      <Hero
        ...
        description="Covenda's AI-SOC for technology companies: preemptive threat intelligence, risk-based vulnerability management, and Forward-Deployed Engineers tuned for software supply chain security, SaaS platform threats, and AI/AGI systems."
      ...
      <FeatureGrid
        title="How Covenda's AI-SOC Serves Technology Companies"
        features={[
          {
            icon: '🔍',
