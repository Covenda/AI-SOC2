  ...
  return (
    <div>
      <Hero
        badge="Why Choose Us"
        title="Why Covenda"
        description="Turn on your AI-SOC instead of building one from scratch. Covenda runs security operations as a product, powered by the Covenda Technology System and Forward-Deployed Engineers."
          ...
          <div className="max-w-4xl mx-auto space-y-16">
            <div>
              ...
              <p className="text-lg text-neutral-700 leading-relaxed mb-4">
                Covenda doesn't help you build an AI-SOC. We are the AI-SOC you turn on. Our platform—the <strong>Covenda Technology System</strong>—delivers continuous threat operations: threat modeling, threat hunting, threat intelligence, threat monitoring, and threat assessment.
              </p>
            ...
            <div>
              ...
              <p className="text-lg text-neutral-700 leading-relaxed mb-4">
                The Covenda Technology System (including Lucid AI) models threats before incidents happen. It's event-agnostic and spec-driven, focusing on the gap between your security posture and actual systems.
              </p>
              <p className="text-lg text-neutral-700 leading-relaxed">
            ...
            <div>
              ...
              <p className="text-lg text-neutral-700 leading-relaxed mb-4">
                Our Forward-Deployed Engineers are product engineers who embed with customers. They bridge the gap between the Covenda Technology System and your messy, real-world environment.
              </p>
              <p className="text-lg text-neutral-700 leading-relaxed mb-4">
            ...
            <div>
              ...
              <p className="text-lg text-neutral-700 leading-relaxed mb-4">
                Covenda started by building a serious product—the Covenda Technology System—that SOC teams could use. Rather than just selling another security tool and waiting for adoption, we flipped the model: we became the AI-SOC provider.
              </p>
              <p className="text-lg text-neutral-700 leading-relaxed">
